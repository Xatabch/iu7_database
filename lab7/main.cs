...
namespace Lab07
{
    ...
    public class UserDataContext
    {
        public class UserDataContext1 : DataContext
        {
            ...
            {
                IExecuteResult result = this.ExecuteMethodCall(this, (MethodInfo)MethodInfo.GetCurrentMethod(), _FirstAge, _SecondAge);
    ...
    class ThirdTask
    {
        ...
        {
            string connectionString = @"server=localhost; database = testdb; user id = sa; password = 0765842953VaNy";
